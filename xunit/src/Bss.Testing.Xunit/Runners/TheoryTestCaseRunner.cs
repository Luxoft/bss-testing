...
public class TheoryTestCaseRunner(
        ...
        cancellationTokenSource)
{
    ...
    protected IMessageSink DiagnosticMessageSink { get; } = diagnosticMessageSink;
    ...
    protected override async Task AfterTestCaseStartingAsync()
        {
            ...
            try
            {
                ...
                foreach (var dataAttribute in dataAttributes)
                {
                    ...
                    {
                       data = dataDiscoverer.GetData(dataAttribute, this.TestCase.TestMethod.Method, testEnvServiceProvider);
                    }
                    else
                    {
